...
def predict_labels_hierarchical_linear_model(hierarchical_linear_model, embeddings, predicted_labels, class_labels, k):
    
    return hierarchical_linear_model.predict(embeddings, predicted_labels, class_labels, k)
